...
function CandidateForm() {
  ...
  const createWhatsAppMessage = () => {
    return `Hello K2 Performing Art Academy,%0A%0AI have submitted the enquiry form.%0A%0AName: ${formData.full_name}%0APhone: ${formData.phone}%0ACourse: ${formData.course}%0APurpose: ${formData.purpose}`;
  };
  ...
  return (
    <section id="candidate-form" className="section form-section">
      ...
      <h2>Join K2 Performing Art Academy</h2>
