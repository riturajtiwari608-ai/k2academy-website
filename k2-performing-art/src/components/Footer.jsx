...
function Footer() {
  ...
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
    "Hello K2 Academy Of Performing Art, I want to know about admission."
  )}`;
  ...
  return (
    <footer className="footer">
      <div className="footer-grid">
        <div>
          <h2>K2 Academy Of Performing Art</h2>
          <p>
      ...
      <p className="copyright">
        © 2026 K2 Academy Of Performing Art. All Rights Reserved.
      </p>
    </footer>
  );
}
